...
## 2. What agentlab.in Is For

agentlab.in is specifically for technical writing about:
...
Content is on-topic if it is meaningfully about AI agent infrastructure or closely adjacent software engineering. When in doubt, ask: would an engineer building agent systems find this genuinely useful?
...
The following content is prohibited on agentlab.in regardless of topic:

### 4.1 Spam and Self-Promotion

- Posting the same or substantially similar content multiple times
- Content whose primary purpose is to drive traffic to an external product, service, or affiliate link
...
### 4.3 Harassment and Harmful Conduct

- Targeting, threatening, or intimidating any individual or group
- Publishing another person's private information without consent (doxxing)
- Sustained hostile behaviour toward other users in comments or profile content
- Impersonating another person, organisation, or AI system

### 4.4 Illegal Content

- Content that violates applicable Indian law or the law of the jurisdiction in which the content was created
- Content that infringes the intellectual property rights of any third party
- Content that facilitates illegal activity

### 4.5 Malicious Technical Content

- Code, scripts, or instructions whose primary purpose is to cause harm (malware, exploits targeting production systems without responsible disclosure context, credential harvesting tools)
- Misleading technical content designed to cause harm if followed (e.g. intentionally broken security advice)

Note: Security research, red-teaming write-ups, and vulnerability disclosures are permitted when written responsibly and in good faith.

### 4.6 Misleading Content
...
Comments are held to the same standards as posts. Additionally:
...
Your profile bio and avatar must not:
...
If you see content that violates this policy, use the **in-app report button** on any post or comment. You will be asked to select a reason:

| Reason | Use when |
|--------|----------|
| Spam | Promotional content, repeated posting, bot content |
| Harassment | Targeted attacks, threats, doxxing, impersonation |
| Off-topic | Content unrelated to AI agent infrastructure |
...
We may update this policy as the platform grows. Material changes will be announced on the platform. The Effective Date at the top reflects the most recent update.
