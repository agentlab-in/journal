...
By accessing or using agentlab.in ("the Platform"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, do not use the Platform.

These Terms form a legally binding agreement between you and Harshit Singh Bhandari, the individual operator of agentlab.in ("we", "us", "our").

---

## 2. What agentlab.in Is

agentlab.in is a free, community publishing platform for technical writing about AI agent infrastructure — architecture patterns, playbooks, and deep dives. It is not a social network, not a marketplace, and not a product built around engagement metrics. It is a place to share knowledge.
...
To create an account, your GitHub account must:

- Be at least **30 days old** at the time of signup
- Have at least **one public repository**
- Not use a reserved username (e.g. "admin", "api")

You must also not be banned from the Platform.
...
- You own or have the right to licence the content
- The content does not infringe any third party's intellectual property, privacy, or other rights
- The content complies with these Terms and our Content Policy

### 4.3 Content Types

The Platform supports three content types:

- **Posts** — general technical articles
...
- Contains spam, unsolicited promotion, or affiliate links
- Harasses, threatens, or targets individuals
- Is off-topic (not related to AI agent infrastructure or software architecture)
...
- Comment on posts (threaded, plain text, up to 5 levels deep)
- Like and bookmark posts
- Follow other users
- Pin up to 6 of their own posts to their profile
- Edit their bio and avatar URL
- Report content that violates the Content Policy

Anyone (including unauthenticated visitors) may read published content.
...
There is no formal appeals process at launch. If you believe moderation action was taken against your content in error, contact harshit@agentlab.in.
...
- That content will never be lost (back up your work)
- That the Platform will remain available indefinitely

We reserve the right to modify, suspend, or discontinue the Platform or any feature at any time, with or without notice. We also reserve the right to update these Terms. Material changes will be announced on the Platform; continued use constitutes acceptance.
...
- agentlab.in is provided **without warranties** of any kind, express or implied
- We do not warrant the accuracy, completeness, or usefulness of any user-generated content
- We are not responsible for content published by users
- We are not liable for any technical failures, data loss, or interruptions
