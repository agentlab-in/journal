...
/**
 * Route-level error boundary for /write — the composer (new drafts +
 * editing existing posts). Renders friendly copy + try-again instead
 * of dumping the editor stack into the page.
 *
  ...
  return (
    <main id="main-content" className="flex flex-1 flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <p className="mt-3 text-sm text-fg-subtle">
        The composer hit an unexpected error. Your draft is autosaved — try
        again to reopen it.
      </p>
