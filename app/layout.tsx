...
export const metadata: Metadata = {
  ...
  icons: {
    // prefers-color-scheme variants — generated by
    // `node scripts/generate-icons.mjs` from public/logo.svg.
    // Light variant: dark mark on white. Dark variant: white mark on
    // near-black. The Next 16 file-convention icons in app/ (icon.png
    // + apple-icon.png) still ship as the unconditional fallback for
    // browsers that don't honor the media query on a <link rel="icon">.
    icon: [
